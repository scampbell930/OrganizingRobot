...
def pickup_object(clientID):
    ...
    err = vrep.simxSetJointTargetPosition(clientID, first_joint, -2, vrep.simx_opmode_oneshot)
    sleep(5)
    err = vrep.simxSetJointTargetPosition(clientID, first_joint, -2, vrep.simx_opmode_oneshot)
    err = vrep.simxSetJointTargetPosition(clientID, third_joint, 1, vrep.simx_opmode_oneshot)
    err = vrep.simxSetJointTargetPosition(clientID, second_joint, -1.5, vrep.simx_opmode_oneshot)
